...
// interface ShoppingMachineContext {
//   cart: Cart;
//   orderId?: string;
//   exception?: string;
// }

// type ShoppingMachineEvent =
// | { type: "toDelivery"; cart: Cart }
// | { type: "toPayment" }
// | { type: "toReview" }
// | { type: "toSendOrder" }
// | { type: "toSendOrderFailure" }
// | { type: "toShopping" }
// | { type: "confirm" }
// | { type: "error" };

// interface ShoppingMachineStateSchema {
//   states: {
//     shopping: {},
//     delivery: {};
//     payment: {};
  ...
  states: {
    ...
    sendOrder: {
      invoke: {
        id: "sendOrder",
        src: fromPromise(({
          //  note, pass `input` to set the context of the actor being invoked
        }) => {
